...
function AdminManageStudentPage() {
  ...
  const displayedStudents = useMemo(() => {
    ...
    return list;
  }, [allStudents, searchTerm, nameSort, statusFilter]);
    ...
    <div className="bg-white">
      <div className="mb-6 md:mb-8 border-b border-gray-200 pb-5">
        ...
        <p className="text-gray-500 mt-1">
          Quản trị danh sách sinh viên, khóa/mở khóa tài khoản và xem chi tiết.
        </p>
      </div>
      ...
      <div className="mb-5 grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
        ...
        <div className="md:col-span-3">
          ...
          >
            ...
            <option value="non-active">Chờ duyệt (non-active)</option>
          </select>
        </div>
      </div>
      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="text-sm text-gray-500">
          Hiển thị:{" "}
          <span className="font-medium">{displayedStudents.length}</span> kết
          quả phù hợp
        </div>
      </div>
